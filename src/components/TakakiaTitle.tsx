...
export default function TakakiaTitle({
    ...
    useEffect(() => {
        function handleKeyDown(e: KeyboardEvent) {
            const currentTitle = titlesRef.current.find(t => t.id === 'takakia');
    ...
    useEffect(() => {
        const syncInterval = setInterval(() => {
            ...
            console.log('Syncing Takakia position:', newX, newY);
    ...
    const title = titlesRef.current.find(t => t.id === 'takakia');
